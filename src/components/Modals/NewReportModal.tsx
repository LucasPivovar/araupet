      ...
      <div className="w-full max-w-sm bg-white rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="bg-gradient-to-r from-[#008779] to-[#006e63] p-5 text-white flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-base">Cadastrar Alerta Pet</h3>
              <p className="text-xs text-teal-100">Perdidos & Encontrados</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-3.5 max-h-[70vh] overflow-y-auto custom-scrollbar">
          {/* Type Toggle */}
          <div>
          ...
          <div>
            ...
            <input
              type="text"
              placeholder={type === 'desaparecido' ? 'Ex: Thor, Bob...' : 'Desconhecido / Provisório'}
              value={name}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-[#008779] resize-none"
            />
          </div>
          ...
          <div className="border-2 border-dashed border-slate-200 rounded-xl p-3 text-center text-slate-500 hover:border-teal-400 cursor-pointer transition-colors bg-slate-50">
            ...
            <p className="text-[11px] font-semibold text-slate-700">Adicionar Foto do Pet</p>
            <p className="text-[9px] text-slate-400">JPG, PNG até 5MB</p>
          </div>

          <button
            type="submit"
            className="w-full py-3 bg-[#008779] hover:bg-[#006e63] text-white rounded-xl font-bold text-xs shadow-md transition-colors"
          >
            Publicar Alerta Imediato
          </button>
        </form>
      </div>
    </div>
